async function getFilmesDetalhe(idFilme) {
    ...
    const res = await fetch(`https://api.themoviedb.org/3/movie/${idFilme}?language=pt-BR`, cabecalho)
    if (!res.ok) {
...
export default getFilmesDetalhe;