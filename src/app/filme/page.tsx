...
async function getData() {
    ...
    const res = await fetch('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=pt-BR&page=1&primary_release_year=2024&sort_by=popularity.desc', cabecalho)
    if (!res.ok) {
    ...
    return (
        <body className="bg-cor-4">
                    ...
                    <div className="container mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <div className="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                            <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                                <li>
                                    <a href="#" className="bg-blue-700 md:bg-transparent text-white block pl-3 pr-4 py-2 md:text-blue-700 md:p-0 rounded text-lg" aria-current="page">Filmes</a>
                                </li>
                                <li>
                                    <a href="#" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0 text-lg">Séries</a>
                                </li>
                                <li>
            ...
            <main className="grid grid-cols-6 min-h-screen bg-cor-1 items-center justify-center p-36 gap-9">
                <div className="flex h-96 w-60 bg-cor-3 rounded-lg hover:scale-105 transition-all">
                ...
                <div className="flex flex-initial h-96 w-60 bg-cor-3 rounded-lg hover:scale-105 transition-all">
                    <div className="bg-cor-2 flex w-full h-9 justify-center items-center rounded-t-lg border-b border-b-cor-1">
                        <h1>Filmes</h1>
                    </div>
                ...
                <div className="flex h-96 w-60 bg-cor-3 rounded-lg hover:scale-105 transition-all flex-col flex-wrap">
                    <div className="bg-cor-2 flex w-full h-9 justify-center items-center rounded-t-lg border-b border-b-cor-1">
                        <h1>Filmes</h1>
                    </div>
