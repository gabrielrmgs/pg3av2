async function getVideoTrailerSerie(idFilme) {
    ...
    const res = await fetch(`https://api.themoviedb.org/3/tv/${idFilme}/videos?language=pt-BR`, cabecalho)
    if (!res.ok) {
...
export default getVideoTrailerSerie;