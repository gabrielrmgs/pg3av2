async function getSeriesDetalhe(idSerie) {
    ...
    const res = await fetch(`https://api.themoviedb.org/3/tv/${idSerie}?language=pt-BR`, cabecalho)
    if (!res.ok) {
...
export default getSeriesDetalhe;